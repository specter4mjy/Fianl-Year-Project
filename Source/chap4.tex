...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6]{"../Photo/Chap1/Class A output stage"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.5]{"../Photo/Chap1/Class A simulation result"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.8]{"../Photo/Chap1/Class A DC operating current"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6 ]{"../Photo/Chap1/Class AB output stage"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6 ]{"../Photo/Chap1/Class AB output stage simlation result"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.8 ]{"../Photo/Chap1/Class AB output stage DC operatingh current data"}
