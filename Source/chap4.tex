...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.5]{"../Photo/Chap4/Class A simulation result"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.8]{"../Photo/Chap4/Class A DC operating current"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6 ]{"../Photo/Chap4/Class AB output stage simlation result"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.8 ]{"../Photo/Chap4/Class AB output stage DC operatingh current data"}
