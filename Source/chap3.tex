...
\begin{figure}[htbp]
\centering
\includegraphics[scale =0.8]{"../Photo/Chap3/single current source"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=1]{"../Photo/Chap3/single current source simulation result"}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.7 ]{"../Photo/Chap3/add cuurent source"}
