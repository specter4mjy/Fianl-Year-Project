...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.6]{"../Photo/Chap1/Op-amp feedback"}
...
\begin{figure}[htbp]
	\centering 
	\includegraphics[scale=0.6]{"../Photo/Chap1/Op-amp feedback simulation wave"}\\[0.5cm]
	\includegraphics[scale =0.8]{"../Photo/Chap1/Op-amp feedback simulation cursor data"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6]{"../Photo/Chap1/transistor feedback"}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6]{"../Photo/Chap1/transistor feedback simulation wave"}\\[0.5cm]
\includegraphics[scale=0.8]{"../Photo/Chap1/transistor feedback simulation cursor data"}
