...
\begin{figure}[htbp]
	...
	\includegraphics[scale =0.8]{"../Photo/Chap2/Op-amp feedback simulation cursor data"}
...
\includegraphics[scale=0.8]{"../Photo/Chap2/transistor feedback simulation cursor data"}
